...
const PublicAssessment = () => {
  ...
  const calculateResults = (): AssessmentResult => {
    ...
    // Generate results based on personality type
    const typeResults = {
      analytical: {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="glass-card border-glass mb-8 text-center">
            <CardContent className="p-6">
              ...
              <h1 className="text-2xl font-bold mb-2">Discover Your Personality</h1>
              <p className="text-muted-foreground">
                Answer a few questions to unlock personalized insights and recommendations
              </p>
            </CardContent>
          </Card>
