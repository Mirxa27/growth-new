                ...
                {questions[currentQuestion]?.options.map((option) => (
                  <div key={option.value} className="relative">
                    ...
                    <Label 
                      ...
                      className="block p-4 rounded-lg border-2 cursor-pointer transition-all hover:border-primary/50 hover:bg-primary/5 peer-checked:border-primary peer-checked:bg-primary/10 text-sm leading-relaxed"
                    >
                      {option.label}
                    </Label>
                  </div>
