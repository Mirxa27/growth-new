...
import { AssessmentTables } from './modules/assessment.types';
import { ContentTables } from './modules/content.types';
import { CommunityTables } from './modules/community.types';
import { AiTables } from './modules/ai.types';
import { PaymentsTables } from './modules/payments.types';
import { PlatformTables } from './modules/platform.types';
