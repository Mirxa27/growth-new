...
const EnhancedRealtimeVoiceAgent: React.FC = () => {
      ...
      wsRef.current.onopen = () => {
        ...
        wsRef.current?.send(JSON.stringify({
          ...
          session: {
            ...
            instructions: voiceConfig?.systemPrompt || "You are NewMe, a supportive growth guide for women's personal growth. Be warm, encouraging, and insightful.",
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span>NewMe Voice Assistant</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="font-medium">Model:</span> {voiceConfig.model}
              </div>
              <div>
                <span className="font-medium">Voice:</span> {voiceConfig.voice}
              </div>
              <div>
                <span className="font-medium">Temperature:</span> {voiceConfig.temperature}
              </div>
              <div>
                <span className="font-medium">Max Tokens:</span> {voiceConfig.maxTokens}
              </div>
            </div>
          </CardContent>
        </Card>
