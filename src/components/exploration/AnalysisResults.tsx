...
export const AnalysisResults = ({ 
  ...
  // Handle AI-generated content - check for analysis field from newer implementation
  const analysisText = (analysis as any).analysis || analysis.content;
  const isAIGenerated = Boolean(analysisText);
  
  const handleDownloadPDF = () => {
    const content = `
${exploration.title}
${'-'.repeat(exploration.title.length)}

Exploration Completed: ${new Date().toLocaleDateString()}

HIGHER SELF ANALYSIS:
${analysisText || 'No analysis available'}

---
Generated by NewMe - Your AI Companion for Personal Growth
    `.trim();
    ...
    a.href = url;
    a.download = `${exploration.title.replace(/[^a-z0-9]/gi, '_').toLowerCase()}_analysis.txt`;
