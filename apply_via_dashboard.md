# Apply Voice Tables via Supabase Dashboard

## Step 1: Go to Supabase Dashboard
Visit: https://supabase.com/dashboard/project/ufgqmqoykddaotdbwteg/sql

## Step 2: Copy and Paste SQL
Copy the entire contents of `apply_voice_tables.sql` and paste it into the SQL editor.

## Step 3: Run the SQL
Click "Run" to apply all the tables.
...
- ✅ voice_agent_configs table created  
- ✅ Default voice configuration inserted
- ✅ RLS policies applied
- ✅ Indexes created

## Step 5: Test the Voice System
...
The voice-to-voice GPT Realtime system is ready for testing!
